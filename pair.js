...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ᴅ 𝐌ɪɴɪ 𝐁ᴏᴛ',
        `📞 Number: ${number}\n🩵 Status: Connected`,
        '> 𝐏ᴏᴡᴇʀᴅ 𝐁ʏ 𝐀ɴᴜɢᴀ 𝐒ᴇɴɪᴛʜᴜ ❗'
    );
...
async function updateAboutStatus(socket) {
    const aboutStatus = '𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ //  𝐀ᴄᴛɪᴠᴇ 𝐍ᴏᴡ 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ 𝐂ᴏɴɴᴇᴄᴛᴇᴅ..! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
╰───────────────────────
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '🧚‍♂️𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ 𝐁ᴏᴛ🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
    ...
    await socket.sendMessage(sender, {
        ...
        caption: formatMessage(
            ...
            `*➤ Available Commands..!! 🌐💭*\n\n┏━━━━━━━━━━━ ◉◉➢
┋ • *BOT INFO*
┋ 🧚‍♂️ Name: 𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ
┋ 🌐 Version: 1v
┋ 👨‍💻 Owner: CYBER ANUWH ( ANUGA SENITHU)
┋ 🌥️ Host: ANUGA SENITHU'S PRIVATE VPS SERVER
┋ 📞 Your Number: ${number}
┋
...
╚══════════════ ⭓⭓ ➣`,
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '🧚‍♂𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ 🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
 ...
 case 'system':
    await socket.sendMessage(sender, {
        image: { url: config.RCD_IMAGE_PATH },
        caption:
            `┏━━【 ✨ANUWH MD MINI BOT STATUS DASHBOARD 】━━◉\n` +
            `┃\n` +
            `┣ 🏓 *PING:* PONG!\n` +
            `┣ 💚 *Status:* Connected\n` +
            `┃\n` +
            ...
            `┃\n` +
            `┣ 🔗 *Our Channels:*\n` +
            `┃     📱 WhatsApp: https://whatsapp.com/channel/0029VbABxI3Gk1Fzt6eY8A0K\n` +
            `┃\n` +
            `┗━━━━━━━【POWERED BY ANUGA SENITHU】━━━━━━◉`
    });
    break;
    ...
    if (args.length === 0) {
        return await socket.sendMessage(sender, {
            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363417186678299@newsletter'
        });
    }
...
`;
        ...
        await socket.sendMessage(sender, {
            text: `⚠️ Error occurred:\n${err.message}`
             ...
             break;
                ...
                case 'owner': {
    const ownerNumber = '94710695082';
    const ownerName = 'ANUGA SENITHU';
    const organization = 'ANUGA SENITHU & CYBERX DEVS TEAM';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ 𝐎ᴡɴᴇʀs*\n\n👤 𝐍𝐀𝐌𝐄: ${ownerName}\n📞 𝐍𝐔𝐌𝐁𝐄𝐑: ${ownerNumber}\n\n> 𝐏ᴏᴡᴇʀᴅ ʙʏ 𝐀ɴᴜɢᴀ 𝐒ᴇɴɪᴛʜᴜ`,
            contextInfo: {
    ...
    await socket.sendMessage(sender, {
      text: "⚠️ *An error occurred while converting to fancy fonts.*"
          ...
          break;
                    ...
                    if (args.length < 2) {
                        return await socket.sendMessage(sender, { 
                            text: "📛 *Usage:* `.boom <count> <message>`\n📌 *Example:* `.boom 100 ᴀɴᴜɢᴀ sᴇɴɪᴛʜᴜ*`" 
                        });
                    }
...
───────────────
✨ *Powered by:* 𝐂ʏʙᴇʀ 𝐀ɴᴜᴡʜ 𝐌ɪɴɪ 𝐌ᴅ ✨
🔗 Join Channel: https://whatsapp.com/channel/0029VbABxI3Gk1Fzt6eY8A0K
